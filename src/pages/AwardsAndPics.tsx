        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <motion.button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-br from-pink-500 to-darkPink text-white font-medium shadow-md hover:shadow-lg transition-all duration-300"
            >
              Photo Collage
            </motion.button>
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => scrollToElement('ibr-section')}
              className="px-6 py-3 rounded-xl bg-gradient-to-br from-amber-500 to-amber-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-300"
            >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => scrollToElement('school-ranks')}
              className="px-6 py-3 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white font-medium shadow-md hover:shadow-lg transition-all duration-300"
            >
              School Ranks
            </motion.button>
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => scrollToElement('college-journey')}
              className="px-6 py-3 rounded-xl bg-gradient-to-br from-violet-500 to-purple-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-300"
            >
              College Journey
            </motion.button>
          </div>
          ...
          <div id="photo-collage" className="mb-24">
            <div className="text-center mb-8">
              <h2 className="text-4xl sm:text-5xl font-extrabold text-darkPink mb-4 leading-tight">
                Photo Collage
              </h2>
              <p className="text-darkPink/70 text-lg max-w-3xl mx-auto mb-6">
                A preview of moments from various events, competitions and collaborations.
              </p>
              
              <div className="bg-pink-50 border border-darkPink/20 p-4 rounded-lg max-w-2xl mx-auto mt-2 mb-6">
                <p className="text-darkPink/90">
                  <span className="font-medium">🔍 Looking for more photos?</span> Check out our dedicated 
                  <Link to="/photos" className="font-bold text-darkPink underline decoration-2 decoration-darkPink/40 hover:decoration-darkPink/80 ml-1">
                    Photo Gallery
                  </Link> 
            ...
            {/* Show a preview of the first few photos */}
            <div className="border-2 border-darkPink/20 p-6 md:p-8 rounded-2xl bg-white/50 backdrop-blur-sm">
              ...
              >
                ...
                >
                  <Masonry gutter="16px">
                    {/* Show only first 6 collage gallery images as a preview */}
                    {collageGallery.slice(0, 6).map((item, index) => (
                      <motion.div
                        key={`collage-${item.id}`}
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="mt-8 text-center">
                  <Link 
                    to="/photos" 
                    className="inline-flex items-center px-8 py-3 bg-darkPink text-white rounded-full font-medium hover:bg-pink-700 transition-colors"
                  >
                    View Full Gallery
          ...
          <div id="ibr-section" className="border-2 border-darkPink/20 p-6 md:p-10 rounded-2xl bg-white/60 backdrop-blur-sm mb-24">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
