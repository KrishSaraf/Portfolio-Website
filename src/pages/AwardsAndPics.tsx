...
const AwardsAndPics = () => {
  ...
  const collageGallery = [
    ...
    // Adding new images to the collage
    {
      id: 'new-landscape-1',
      src: "/images/new-image1.jpg", 
      alt: "Project showcase",
      description: "Presenting at technology exhibition",
      aspectRatio: 16/9,
      highlight: true,
      objectPosition: "center center",
    },
    {
      id: 'new-square-1',
      src: "/images/new-image2.jpg", 
      alt: "Team collaboration",
      description: "Brainstorming session with partners",
      aspectRatio: 1/1,
      highlight: false,
      objectPosition: "center center",
    },
    {
      id: 'new-portrait-1',
      src: "/images/new-image3.jpg", 
      alt: "Award ceremony",
      description: "Receiving innovation recognition",
      aspectRatio: 3/4,
      highlight: false,
      objectPosition: "center center",
    },
    {
      id: 'new-landscape-2',
      src: "/images/new-image4.jpg", 
      alt: "Conference keynote",
      description: "Delivering presentation at industry event",
      aspectRatio: 16/9,
      highlight: false,
      objectPosition: "center center",
    },
