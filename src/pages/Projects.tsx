                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {project.title === "IEEE NTU & NUS Synapse Hackathon 2024" && (
                        <Link to="/awards?event=synapse" className="px-6 py-3 text-sm font-semibold text-white bg-purple-600 rounded-xl hover:bg-purple-700 transition-colors duration-200 flex items-center gap-2 group-hover:shadow-md">
                          View Pics
                          <span className="transform group-hover:translate-x-1 transition-transform duration-200">→</span>
                        </Link>
                      )}
                      ...
                      {project.title === "NTU IEEE Intuition Hackathon" && (
                        <Link to="/awards?event=intuition" className="px-6 py-3 text-sm font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-colors duration-200 flex items-center gap-2 group-hover:shadow-md">
                          View Pics
                          <span className="transform group-hover:translate-x-1 transition-transform duration-200">→</span>
                        </Link>
                      )}
                      ...
                      {project.title === '"Code with AI" Hackathon - Get My Leadz' && (
                        <Link to="/awards?event=codewithai" className="px-6 py-3 text-sm font-semibold text-white bg-amber-600 rounded-xl hover:bg-amber-700 transition-colors duration-200 flex items-center gap-2 group-hover:shadow-md">
                          View Pics
                          <span className="transform group-hover:translate-x-1 transition-transform duration-200">→</span>
                        </Link>
                      )}
                      ...
                      {project.title === "NTU PEAK Leadership Program" && (
                        <Link to="/awards?event=peak" className="px-6 py-3 text-sm font-semibold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-colors duration-200 flex items-center gap-2 group-hover:shadow-md">
                          View Pics
                          <span className="transform group-hover:translate-x-1 transition-transform duration-200">→</span>
                        </Link>
                      )}
                      ...
                      {project.title === "Surgical Gauze Detection using Computer Vision" && (
                        <Link to="/awards?event=gauze" className="px-6 py-3 text-sm font-semibold text-white bg-teal-600 rounded-xl hover:bg-teal-700 transition-colors duration-200 flex items-center gap-2 group-hover:shadow-md">
                          View Media
                          <span className="transform group-hover:translate-x-1 transition-transform duration-200">→</span>
                        </Link>
                      )}
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    {projects[selected].title === "NTU IEEE Intuition Hackathon" && (
                      <Link
                        ...
                        onClick={() => setSelected(null)}
                        className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors duration-200"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                    ...
                    {projects[selected].title === '"Code with AI" Hackathon - Get My Leadz' && (
                      <Link
                        ...
                        onClick={() => setSelected(null)}
                        className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-amber-600 rounded-lg hover:bg-amber-700 transition-colors duration-200"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                    ...
                    {projects[selected].title === "Surgical Gauze Detection using Computer Vision" && (
                      <Link
                        ...
                        onClick={() => setSelected(null)}
                        className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-teal-600 rounded-lg hover:bg-teal-700 transition-colors duration-200"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
