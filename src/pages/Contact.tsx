...
const Contact = () => {
  ...
  return (
    <section className="section-padding py-12 relative overflow-hidden bg-gradient-to-b from-white to-pink-50">
      ...
      <div className="max-w-6xl mx-auto px-[var(--mobile-padding)] sm:px-4 relative z-10">
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <motion.div 
            className="text-center mb-10 md:mb-16 mt-6 md:mt-12"
            variants={itemVariants}
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-darkPink tracking-tight mb-6 relative inline-block">
              <span className="relative z-10">Get In Touch</span>
              <div className="absolute -bottom-4 left-0 w-full h-4 bg-darkPink/20 -z-10 skew-x-3 rounded"></div>
            </h2>

            <p className="text-darkPink/70 text-base md:text-lg mb-2 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
            ...
            <motion.div 
              className="md:w-2/3 order-2 md:order-1 w-full"
              variants={itemVariants}
            >
              <form 
                ref={form} 
                onSubmit={handleSubmit} 
                className="space-y-6 md:space-y-8 bg-white p-5 md:p-8 rounded-xl shadow-lg border border-darkPink/10 relative overflow-hidden w-full"
              >
                ...
                <div className="relative">
                  <label
                    htmlFor="name"
                    className={`block text-sm md:text-base font-medium mb-2 transition-all duration-200 ${
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                    className="w-full px-4 md:px-5 py-3 md:py-4 text-base bg-white border rounded-lg text-darkPink/90 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-darkPink/50 focus:border-darkPink"
                    required
                  />
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onBlur={handleBlur}
                    rows={6}
                    className="w-full px-4 md:px-5 py-3 md:py-4 text-base bg-white border rounded-lg text-darkPink/90 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-darkPink/50 focus:border-darkPink resize-none"
                    required
                  />
                  <div className={`h-0.5 bg-darkPink scale-x-0 transition-transform duration-300 origin-left ${
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-darkPink text-white font-semibold py-3 md:py-3.5 px-4 md:px-6 rounded-lg hover:bg-darkPink/90 focus:outline-none focus:ring-2 focus:ring-darkPink/50 focus:ring-offset-2 transition-all duration-300 ease-in-out shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center text-sm md:text-base"
                  variants={itemVariants}
                >
                  {isSubmitting ? (
                    <>
            ...
            >
              <div className="mb-8 md:mb-12 w-full">
                <h3 className="text-xl md:text-2xl font-bold text-darkPink mb-6 md:mb-8 relative inline-block">
                ...
                <div className="flex flex-col gap-4 md:gap-5 mt-4 md:mt-6">
                  <motion.a
                    ...
                    className="flex items-center gap-3 md:gap-4 text-darkPink/80 hover:text-darkPink transition-all duration-300 p-4 md:p-6 rounded-lg border border-darkPink/10 bg-white shadow-sm hover:shadow-md group"
                    aria-label="GitHub Profile"
                  >
                    <span className="bg-darkPink/10 text-darkPink p-2 md:p-3 rounded-full transition-all duration-300 group-hover:bg-darkPink group-hover:text-white">
                      <FaGithub size={24} className="text-[var(--mobile-icon-size)]" />
                    </span>
                  ...
                  >
                    <span className="bg-darkPink/10 text-darkPink p-2 md:p-3 rounded-full transition-all duration-300 group-hover:bg-darkPink group-hover:text-white">
                      <FaLinkedin size={24} className="text-[var(--mobile-icon-size)]" />
                    </span>
                  ...
                  >
                    <span className="bg-darkPink/10 text-darkPink p-2 md:p-3 rounded-full transition-all duration-300 group-hover:bg-darkPink group-hover:text-white">
                      <FaEnvelope size={24} className="text-[var(--mobile-icon-size)]" />
                    </span>
                    <span className="font-medium text-base md:text-lg">Email Me</span>
                    <span className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300">→</span>
                  </motion.a>
                </div>
              </div>
